...
const data = [
  { name: "Arjun Kapoor", email: "a-kapoor@kellogg.edu", initials: "AK", bg: "bg-dark-green", course: "IB Interview Mastery", enrolled: "Jan 10", status: "Completed" },
  { name: "Sofia Lin", email: "s-lin@kellogg.edu", initials: "SL", bg: "bg-[#6B7280]", course: "Consulting Case Prep", enrolled: "Jan 12", status: "Attended" },
  { name: "Marcus Park", email: "m-park@kellogg.edu", initials: "MP", bg: "bg-[#9333EA]", course: "PE Deal Fundamentals", enrolled: "Jan 15", status: "Not Attended" },
  { name: "Rachel Torres", email: "r-torres@kellogg.edu", initials: "RT", bg: "bg-[#DC2626]", course: "IB Interview Mastery", enrolled: "Jan 18", status: "Not Started" },
  { name: "Daniel Wu", email: "d-wu@kellogg.edu", initials: "DW", bg: "bg-[#0891B2]", course: "Startup Finance & VC", enrolled: "Jan 20", status: "Completed" },
];
...
export default function B2BSelfStudy() {
  ...
  return (
    <>
      <div className="mb-6 flex items-start justify-between">
        <div>
          <h1 className="text-[40px] font-medium text-gray-dark">Self-Study Courses</h1>
          <p className="mt-[2px] text-[18px] text-[#707070]">Online course access tracking for all enrolled users</p>
        </div>
      ...
      <div className="mb-5 grid grid-cols-4 gap-4">
        <StatCard
          ...
          value={<>74 <span className="text-[16px] font-bold text-gray-light">/ 89</span></>}
          sub="83% enrollment rate"
        />
        <StatCard
          label="Total Completions"
          value={<>45 <span className="text-[16px] font-bold text-gray-light">/ 74</span></>}
          sub="61% completion rate"
